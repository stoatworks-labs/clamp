/*
 * Stoatworks Labs - About window data for clamp.
 *
 * PROVISIONAL HAND COPY, in the shape stoatworks-backend/scripts/sync-about.py
 * generates (adapted from standards' hand copy on 2026-09-23). The
...
namespace stoatworks::about
{
    ...
    inline constexpr auto hook = "An AC-coupled video amplifier whose DC restoration has failed, for Resolume";
    ...
    inline constexpr auto repo = "https://github.com/stoatworks-labs/clamp";
