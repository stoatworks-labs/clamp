/**
	...
	`CFFGLPluginInfo` that Clamp.cpp registers at static-initialisation time.
	...
	binary: which build it is.
		...
		strings Clamp.bundle/Contents/MacOS/Clamp | grep clamp
*/

extern "C" const char* ClampBuildStamp()
{
	return "clamp " CLAMP_VERSION " built " __DATE__ " " __TIME__;
}
